...
That's lock step: the agent and the standards moving together, gated at each file write and at each turn end, with reviewer memory that survives the stateless calls. The writer now has an editor, and the editor remembers yesterday's conversation.
